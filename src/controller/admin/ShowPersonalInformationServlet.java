...
/**
 * Servlet implementation class ShowPersonalInformationServlet
 */
@WebServlet("/ShowPersonalInformation")
public class ShowPersonalInformationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ShowPersonalInformationServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("user".equals(decentralization)) {
			...
			RequestDispatcher dispatcher = request.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/admin/ShowPersonalInformation.jsp");
