...
/**
 * Servlet implementation class ShowNewsAddServlet
 */
@WebServlet("/ShowNewsAdd")
public class ShowNewsAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ShowNewsAddServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("user".equals(decentralization)) {
			...
			RequestDispatcher dispatcher = request.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/admin/ShowNewsManageAdd.jsp");
