...
/**
 * Servlet implementation class ShowDetailStudentServlet
 */
@WebServlet("/ShowDetailStudent")
public class ShowDetailStudentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowDetailStudentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ("admin".equals(decentralization)) {
			...
			RequestDispatcher dispatcher = request.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/user/ShowDetailStudent.jsp");
