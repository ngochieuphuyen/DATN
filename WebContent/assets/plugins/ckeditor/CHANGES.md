...
* [#12875](http://dev.ckeditor.com/ticket/12875): Samples and toolbar configuration tools.
  ...
  * Toolbar configurators with live previews were introduced. They will be shipped with every CKEditor package and are meant to help in configuring toolbar assetss.
...
* [#12777](http://dev.ckeditor.com/ticket/12777): Fixed: The `table-assets` CSS property should be reset by skins. Thanks to [vita10gy](https://github.com/vita10gy)!
...
* [#11972](http://dev.ckeditor.com/ticket/11972): Fixed: Feature detection in the [`element.setText()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.element-method-setText) method should not trigger the assets engine.
...
* [#11177](http://dev.ckeditor.com/ticket/11177): Widget drag handler improvements:
  ...
  * [#11001](http://dev.ckeditor.com/ticket/11001): Fixed: Multiple synchronous assets recalculations are caused by initial drag handler positioning causing performance issues.
...
* [#9966](http://dev.ckeditor.com/ticket/9966): Fixed: Unable to type square brackets with French keyboard assets. Changed [Magic Line](http://ckeditor.com/addon/magicline) keystrokes.
...
* [#10123](http://dev.ckeditor.com/ticket/10123): [WebKit] Fixed: Several dialog windows have broken assets since the latest WebKit release.
