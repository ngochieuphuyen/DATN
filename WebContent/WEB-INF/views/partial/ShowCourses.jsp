	...
	<section class="content">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title col-sm-7">List Courses</h3>
			...
			<div class="box-body">
				<table class="table table-bordered" id="myTable">
						...
						<tr>
							...
							<th>
								<div class="pull-right">
									<a href="ShowCourseAdd" class="btn btn-info"><i
					...
					<tr>
						<td><%=(i + 1)%></td>
						<td><a
							href="ShowClasses?class=<%="CourseWith" + listCourse.get(i).getIdCourse()%>"><%=listCourse.get(i).getCourseName()%></a></td>

						<td><div class="pull-right">
								<a
									href="ShowCourseEdit?idCourse=<%=listCourse.get(i).getIdCourse()%>"
									class="btn btn-primary"><i class="fa fa-pencil"
									aria-hidden="true"></i></a> <a href="#confirmDeleteCourse<%=i%>"
									role="button" data-toggle="modal" class="btn btn-danger"><i
									class="fa fa-trash" aria-hidden="true"></i></a>
							</div>

							<div class="modal fade" id="confirmDeleteCourse<%=i%>"
								role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<a
												href="DoCourseDelete?idCourse=<%=listCourse.get(i).getIdCourse()%>"
