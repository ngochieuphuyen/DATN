...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-primary">
			...
			<!--  ending header Table -->
			<div class="box-body">
				<form action="DoCourseEdit" method="post">
					<div class="form-group">
						<label>Course Name</label>
						<input type="text" class="form-control"
							placeholder="Course Name" name="CourseName" value="<%=course.getCourseName() %>" required="required">
							
					</div>
					
					<div class="form-group" hidden="">
						<input type="text" class="form-control"
							 name="IdCourse" value="<%=course.getIdCourse() %>" >
					</div>
					<div class="form-group">
